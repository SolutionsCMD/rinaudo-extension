...
// Fire-and-forget client diagnostics → server (bearer-auth). Used to trace the X comment
// flow without asking users to open a console. Silently no-ops when not connected.
